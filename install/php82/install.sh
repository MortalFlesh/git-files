...
cp /usr/local/etc/php/8.2/php.ini ~/www/git-files/install/php82/backup/
...
ls -FGlh /usr/local/etc/php/8.2/php.ini
ln -s -f ~/www/git-files/install/php82/php.ini /usr/local/etc/php/8.2/php.ini
ls -FGlh /usr/local/etc/php/8.2/php.ini
