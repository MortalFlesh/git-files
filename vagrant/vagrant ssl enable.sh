...
echo "Organization Name (eg, company) [Default Company Ltd]:Company"
echo "Organizational Unit Name (eg, section) []:Edu"
echo "Common Name (eg, your name or your server's hostname) []:host.cz"
echo "Email Address []:admin@host.cz"
echo "==================="
